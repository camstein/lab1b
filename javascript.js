mapboxgl.accessToken = 'pk.eyJ1IjoiY2FtZXJvbnN0ZWluZXIzMSIsImEiOiJja2szcWV3aG4wMXJmMndsaGV0Mm9qaDNrIn0.-HtiggKqG14xmsRD2uH2PQ'
  ...
  map.on('click', 'hospitals', function(e) {
    ...
    popup.setLngLat(feature.geometry.coordinates)
      .setHTML(feature.properties.NAME + "<br/>" + feature.properties.ADDRESS + "<br/>" + feature.properties.CITY + ", WA<br/>" + feature.properties.ZIP)
      .addTo(map);
  });
  ...
  map.on('click', 'libraries', function(f) {
    ...
    var from = turf.point([refLibrary.geometry.coordinates[0], refLibrary.geometry.coordinates[1]]);
    var to = turf.point([nearestHospital.geometry.coordinates[0], nearestHospital.geometry.coordinates[1]]);
    ...
    popup.setLngLat(refLibrary.geometry.coordinates)
      .setHTML('<b>' + refLibrary.properties.NAME + '</b><br>The nearest hospital is ' + nearestHospital.properties.NAME + ', located at ' + nearestHospital.properties.ADDRESS + ". It is " + distance1 + " miles away.")
      .setMaxWidth('325px')
      .addTo(map);
  });
